        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastMessages = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    Input = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    Output = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    NodeStates = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.AddForeignKey(
                ...
                table: "FlowSnapshot",
                schema: _schema, column: "WorkflowId",
