...
namespace Juice.EF.Tests.SqlServer.Migrations
{
    ...
    [Migration("20260206103111_ChangeOutboxDateType")]
    partial class ChangeOutboxDateType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Juice.Messaging.OutboxDelivery", b =>
                {
            ...
            modelBuilder.Entity("Juice.Messaging.OutboxEvent", b =>
                {
                    b.Property<Guid>("EventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Juice.Messaging.OutboxDelivery", b =>
                {
                    b.HasOne("Juice.Messaging.OutboxEvent", "OutboxEvent")
                        .WithMany("Deliveries")
