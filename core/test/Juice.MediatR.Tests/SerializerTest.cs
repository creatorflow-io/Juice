...
namespace Juice.MediatR.Tests
{
    public class SerializerTest
    {
        ...
        public SerializerTest(ITestOutputHelper testOutput)
        {
            ...
            var logger = provider.GetRequiredService<ILogger<NewtonsoftSerializer>>();
            _serializer = new NewtonsoftSerializer(logger);
        }
        ...
        public void Should_Serialize_And_Deserialize_String()
        {
            ...
            // Act
            var serialized = _serializer.SerializeResponse(original);
            var deserialized = _serializer.DeserializeResponse<string>(serialized);
        ...
        {
            // Act
            var serialized = _serializer.SerializeResponse((string?)null);
            var deserialized = _serializer.DeserializeResponse<string>(serialized);
        ...
        public void Should_Serialize_And_Deserialize_Int()
        {
            ...
            // Act
            var serialized = _serializer.SerializeResponse(original);
            var deserialized = _serializer.DeserializeResponse<int>(serialized);
        ...
        public void Should_Serialize_And_Deserialize_Guid()
        {
            ...
            // Act
            var serialized = _serializer.SerializeResponse(original);
            var deserialized = _serializer.DeserializeResponse<Guid>(serialized);
        ...
        public void Should_Serialize_And_Deserialize_DateTime()
        {
            ...
            // Act
            var serialized = _serializer.SerializeResponse(original);
            var deserialized = _serializer.DeserializeResponse<DateTime>(serialized);
        ...
        public void Should_Serialize_And_Deserialize_Concrete_Class()
        {
            ...
            // Act
            var serialized = _serializer.SerializeResponse(original);
            var deserialized = _serializer.DeserializeResponse<TestData>(serialized);
        ...
        public void Should_Serialize_And_Deserialize_IOperationResult()
        {
            ...
            var deserialized = _serializer.DeserializeResponse<IOperationResult>(serialized);
        ...
        public void Should_Serialize_And_Deserialize_IOperationResult_Generic()
        {
            ...
            var deserialized = _serializer.DeserializeResponse<IOperationResult<string>>(serialized);
        ...
        public void Should_Serialize_And_Deserialize_IOperationResult_Complex_Data()
        {
            ...
            var deserialized = _serializer.DeserializeResponse<IOperationResult<TestData>>(serialized);
        ...
        public void Should_Serialize_And_Deserialize_List()
        {
            ...
            var deserialized = _serializer.DeserializeResponse<List<TestData>>(serialized);
        ...
        {
            // Act
            var serialized = _serializer.SerializeResponse((object?)null);
            var deserialized = _serializer.DeserializeResponse<object>(serialized);
        ...
        {
            // Act
            var deserialized = _serializer.DeserializeResponse<string>(null);
        ...
        public void Should_Handle_Nested_Objects()
        {
            ...
            var deserialized = _serializer.DeserializeResponse<NestedTestData>(serialized);
        ...
        public void Should_Handle_Type_Preservation()
        {
            ...
            var deserialized = _serializer.DeserializeResponse<IOperationResult<int>>(serialized);
        ...
        public void Should_Return_Default_When_Deserializing_Invalid_Json()
        {
            ...
            // Act
            var deserialized = _serializer.DeserializeResponse<TestData>(invalidJson);
        ...
        public void Should_Handle_Interface_Without_Type_Gracefully()
        {
            ...
            // Act
            var deserialized = _serializer.DeserializeResponse<IOperationResult>(jsonWithoutType);
