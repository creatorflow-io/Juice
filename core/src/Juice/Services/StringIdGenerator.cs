...
{
    public sealed class StringIdGenerator : IStringIdGenerator
    {
        ...
        private static readonly StringIdGenerator _instance = new StringIdGenerator();
        public static StringIdGenerator Instance => _instance;
    }
}
